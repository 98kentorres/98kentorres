...
if(isset($_POST['save'])){
  ...
  $result2 = mysqli_query($db,$query2);
    ...
    $query6 = "insert into logs (activity,date) VALUES ('$item_name quantity has been reduced by:$qty | HANDLED BY: $user ','$date')";
...
?>
	...
	<form method="post" action="sales.php">
        <table>
			...
			<tbody>
                <tr>
                    ...
                    <td> <input type="text" name="customer_name" value="<?php echo $customer_name; ?>" class="myinput"></td>
                    <td><input type="text" name="cash" value="<?php echo $cash; ?>" class="myinput"></td>
                    <td><input type="text" name="note" value="<?php echo $note; ?>" class="myinput"></td>
                </tr>
        </table>
        <br>
         <table>
		...
		<button type="submit" class="btn btn-primary sub" style="width: 10%;"name="save">PROCEED</button>
  ...
  <th class="th-css">TOTAL</th>
			...
			<tbody>
                <tr>
                    ...
                    <td><input type="text" name="expiration_date" value="<?php echo $expiration_date; ?>" class="myinput" title="READ ONLY" readonly></td>
                    <td> <input type="text" name="selling_price" value="<?php echo $selling_price; ?>" class="myinput" title="READ ONLY" readonly></td>
                    <td><input type="text" name="qty" value="<?php echo $qty; ?>" class="myinput" title="READ ONLY" readonly></td>
                </tr>
        </table>
        <br>
        </form>
